package com.example.oauthjwtfinal.config;

import com.example.oauthjwtfinal.domain.Role;
import com.example.oauthjwtfinal.security.CustomUserDetailsService;
import com.example.oauthjwtfinal.security.TokenAuthenticationFilter;
import com.example.oauthjwtfinal.security.oauth2.CustomOAuth2UserService;
import com.example.oauthjwtfinal.security.oauth2.HttpCookieOAuth2AuthorizationRequestRepository;
import com.example.oauthjwtfinal.security.oauth2.OAuth2AuthenticationFailureHandler;
import com.example.oauthjwtfinal.security.oauth2.OAuth2AuthenticationSuccessHandler;
    ...
    */
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/auth/**", "/oauth2/**", "/login/**", "/token/**").permitAll()
